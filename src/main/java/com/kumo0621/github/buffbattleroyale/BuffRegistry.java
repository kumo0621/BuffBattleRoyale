...
public class BuffRegistry {
    ...
    static {
        ...
        registerBuffItem(new BuffItemData("attack2", Material.PAPER, 4, PotionEffectType.STRENGTH, "攻撃力上昇 (Level 2)","", 2,0.05));
        registerBuffItem(new BuffItemData("attack3", Material.PAPER, 29, PotionEffectType.STRENGTH, "攻撃力上昇 (Level 3)","", 3,0.02));
        ...
        registerBuffItem(new BuffItemData("heel2", Material.PAPER, 6, PotionEffectType.REGENERATION, "再生 (Level 2)","", 2,0.05));
        registerBuffItem(new BuffItemData("heel3", Material.PAPER, 28, PotionEffectType.REGENERATION, "再生 (Level 3)","", 3,0.02));
        // ジャンプバフ（Jump：JUMP）
        ...
        registerBuffItem(new BuffItemData("levitation2", Material.PAPER, 10, PotionEffectType.LEVITATION, "浮遊(Level 2)","", 2,0.05));
        registerBuffItem(new BuffItemData("levitation3", Material.PAPER, 30, PotionEffectType.LEVITATION, "浮遊(Level 3)","", 3,0.03));
